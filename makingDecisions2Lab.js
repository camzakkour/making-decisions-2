...
for (let v = 0; v < nums.length; v++) {
  if (nums[v] % 2 === 0) {
    evensArr.push(nums[v])
    console.log("This is original nums array:", nums, "This is evens array:", evensArr)
  }
}
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,32];
// Do not edit the code above.
...
for (j = 0; j < listOfNumbers.length; j++) {
  if (listOfNumbers[j] % 3 === 0) {
    console.log("{", listOfNumbers[j], "} is divisible by 3.")
  }
}
